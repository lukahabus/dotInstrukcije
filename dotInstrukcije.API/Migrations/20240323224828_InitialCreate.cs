    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructionsDates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstructionsDates_Professors_ProfessorId",
                        column: x => x.ProfessorId,
                        principalTable: "Professors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InstructionsDates_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructionsDates_ProfessorId",
                table: "InstructionsDates",
                column: "ProfessorId");

            migrationBuilder.CreateIndex(
                name: "IX_InstructionsDates_StudentId",
                table: "InstructionsDates",
                column: "StudentId");
